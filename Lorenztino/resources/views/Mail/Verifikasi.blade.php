...
<body>
    <div style="background-image: url(http://lorensonia.com/email/cover.jpg); width: 800px; height: 400px; text-align: center">
        ...
        <div style="width: 600px; margin: 0 auto; padding: 0;">
            ...
            <button style="width: 200px; height: 50px;color:white; background-color: #B86B77; border: none"><a style="color: white;font-size: 30pt" href="{{url('/verify')}}/{{ $pesan['kode'] }}">Verify</a></button>
